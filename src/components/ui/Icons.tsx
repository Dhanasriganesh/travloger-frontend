...
export const CurrencyRupeeIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <text x="12" y="17" textAnchor="middle" fontSize="14" fill="currentColor" fontFamily="Arial, sans-serif" fontWeight="bold">₹</text>
  </svg>
)
...
export const BuildingLibraryIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const HashtagIcon: React.FC<IconProps> = ({ className = "h-5 w-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
